public class Burger extends Item {
    ...
    public double getExtraPrice(String toppingName) {
        ...
        switch(toppingName.toUpperCase()) {
            case "CHEESE": toppingPrice = 1.0; break;
            case "AVOCADO": toppingPrice = 1.0; break;
            case "HAM": toppingPrice = 1.5; break;
            case "SALAMI": toppingPrice = 1.5; break;
            case "BACON": toppingPrice = 1.5; break;
            default: toppingPrice = 0.0;
        };
        return toppingPrice;
    }
